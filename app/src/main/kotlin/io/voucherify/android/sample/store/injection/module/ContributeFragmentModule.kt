...
import io.voucherify.android.sample.store.injection.module.history.details.CustomerOrderHistoryDetailsFragmentModule
...
@Module(
    includes = [
        ...
        CustomerOrderHistoryDetailsFragmentModule::class
    ]
)

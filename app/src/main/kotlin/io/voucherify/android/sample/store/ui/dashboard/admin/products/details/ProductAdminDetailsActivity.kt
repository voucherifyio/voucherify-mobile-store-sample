...
class ProductAdminDetailsActivity: BaseActivity() {
    ...
    companion object Factory {
        ...
        fun createIntent(context: Context, product: ProductResponse) =
            Intent(context, ProductAdminDetailsActivity::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_product_admin_details)
        ...
        if(savedInstanceState == null) {
            addFragment(
                R.id.product_admin_details_fragment_container,
